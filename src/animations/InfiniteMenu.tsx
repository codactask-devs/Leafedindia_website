...
class DiscGeometry extends Geometry {
    constructor(steps = 4, radius = 1) {
        ...
        for (let i = 0; i < safeSteps; ++i) {
            ...
            this.lastVertex.uv[0] = x * 0.48 + 0.5;
            this.lastVertex.uv[1] = y * 0.48 + 0.5;
...
class InfiniteGridMenu {
    ...
    private init(onInit?: InitCallback): void {
        ...
        this.discGeo = new DiscGeometry(128, 1);
    ...
    private render(): void {
        ...
        gl.clearColor(220 / 255, 252 / 255, 231 / 255, 1.0);
...
const InfiniteMenu = ({
    ...
    return (
        <div className="relative w-full h-full bg-[#dcfce7]">
            <canvas
          ...
          transition-all
          ease-[cubic-bezier(0.25,0.1,0.25,1.0)] text-[#064e3b] leading-13
          ${isMoving
